...
<div class="glass p-8 rounded-3xl max-w-4xl mx-auto">
    <form action="{{ route('admin.clients.update', $client) }}" method="POST" enctype="multipart/form-data" class="space-y-6">
        ...
        <div>
            ...
            <textarea name="description" id="description" rows="4" placeholder="Brief details about the client, project, or partnership...">{{ old('description', $client->description) }}</textarea>
        </div>

        <div>
            <label for="logo">Client Logo (Leave blank to keep current)</label>
