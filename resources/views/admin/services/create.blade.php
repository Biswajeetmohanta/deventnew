    ...
    <form action="{{ route('admin.services.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
                ...
                <input type="text" name="title" id="title" required value="{{ old('title') }}" placeholder="e.g. Web Development">
            </div>

            <div>
                <label for="icon">FontAwesome Icon</label>
                <input type="text" name="icon" id="icon" value="{{ old('icon') }}" placeholder="fa-solid fa-code">
            </div>
        </div>

        <div>
            <label for="summary">Summary (Short Intro)</label>
            <textarea name="summary" id="summary" rows="3" placeholder="Briefly describe the service...">{{ old('summary') }}</textarea>
        </div>

        <div>
            <label for="description">Full Description</label>
            <textarea name="description" id="description" rows="6" placeholder="Detailed service description...">{{ old('description') }}</textarea>
        </div>
            ...
            <div class="bg-slate-50 p-6 rounded-2xl mb-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                    <div>
                        ...
                        <input type="text" name="banner_title" id="banner_title" value="{{ old('banner_title') }}" placeholder="e.g. Custom Software Development Services">
                    </div>
                    <div>
                        <label for="banner_subtitle" class="text-xs">Banner Subtitle</label>
                        <input type="text" name="banner_subtitle" id="banner_subtitle" value="{{ old('banner_subtitle') }}" placeholder="e.g. We build scalable and secure software solutions.">
                    </div>
                </div>
                <div>
...
24/7 Support">{{ old('highlights_raw') }}</textarea>
                </div>
            </div>
            ...
            <div class="bg-slate-50 p-6 rounded-2xl mb-6">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="features_title" id="features_title" value="{{ old('features_title') }}" placeholder="e.g. Our Core Features">
                </div>
                <div>
            ...
            <div class="bg-slate-50 p-6 rounded-2xl mb-6">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="approach_title" id="approach_title" value="{{ old('approach_title') }}" placeholder="e.g. Our Proven Approach">
                </div>
                <div class="mb-4">
                    <label for="approach_description" class="text-xs">Approach Description (Paragraph 1)</label>
                    <textarea name="approach_description" id="approach_description" rows="3" placeholder="e.g. We follow a client-centric approach to deliver high-quality solutions.">{{ old('approach_description') }}</textarea>
                </div>
                <div>
                    <label for="approach_description2" class="text-xs">Approach Description (Paragraph 2)</label>
                    <textarea name="approach_description2" id="approach_description2" rows="3" placeholder="e.g. Our team ensures seamless communication throughout the project life cycle.">{{ old('approach_description2') }}</textarea>
                </div>
            </div>
            ...
            <div class="bg-slate-50 p-6 rounded-2xl mb-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                    <div>
                        ...
                        <input type="text" name="solutions_title" id="solutions_title" value="{{ old('solutions_title') }}" placeholder="e.g. Comprehensive Solutions">
                    </div>
                    <div>
                        <label for="solutions_subtitle" class="text-xs">Section Subtitle</label>
                        <input type="text" name="solutions_subtitle" id="solutions_subtitle" value="{{ old('solutions_subtitle') }}" placeholder="e.g. Tailored solutions for your business.">
                    </div>
                </div>
                <div>
            ...
            <div class="bg-slate-50 p-6 rounded-2xl mb-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
                    <div>
                        ...
                        <input type="text" name="cta_title" id="cta_title" value="{{ old('cta_title') }}" placeholder="e.g. Want to Consult Our Experts?">
                    </div>
                    <div>
                        <label for="cta_subtitle" class="text-xs">CTA 1 Subtitle</label>
                        <input type="text" name="cta_subtitle" id="cta_subtitle" value="{{ old('cta_subtitle') }}" placeholder="e.g. Contact our team today!">
                    </div>
                    <div>
                        <label for="cta_button" class="text-xs">CTA 1 Button Text</label>
                        <input type="text" name="cta_button" id="cta_button" value="{{ old('cta_button') }}" placeholder="e.g. Connect With Us Today">
                    </div>
                </div>
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <div>
                        <label for="cta2_title" class="text-xs">CTA 2 Title</label>
                        <input type="text" name="cta2_title" id="cta2_title" value="{{ old('cta2_title') }}" placeholder="e.g. Looking for Other Services?">
                    </div>
                    <div>
                        <label for="cta2_subtitle" class="text-xs">CTA 2 Subtitle</label>
                        <input type="text" name="cta2_subtitle" id="cta2_subtitle" value="{{ old('cta2_subtitle') }}" placeholder="e.g. Explore our other offerings.">
                    </div>
                    <div>
                        <label for="cta2_button" class="text-xs">CTA 2 Button Text</label>
                        <input type="text" name="cta2_button" id="cta2_button" value="{{ old('cta2_button') }}" placeholder="e.g. Let's Connect">
                    </div>
                </div>
            </div>
            ...
            <div class="bg-slate-50 p-6 rounded-2xl mb-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                    ...
                    <div>
                        ...
                        <input type="text" name="process_subtitle" id="process_subtitle" value="{{ old('process_subtitle') }}" placeholder="e.g. How we bring your idea to life.">
                    </div>
                </div>
                <div class="mb-4">
            ...
            <div class="bg-slate-50 p-6 rounded-2xl mb-6">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="frameworks_title" id="frameworks_title" value="{{ old('frameworks_title') }}" placeholder="e.g. Technologies We Use">
                </div>
                <div>
            ...
            <div class="bg-slate-50 p-6 rounded-2xl mb-6">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="why_choose_title" id="why_choose_title" value="{{ old('why_choose_title') }}" placeholder="e.g. Why Choose Us?">
                </div>
                <div class="mb-4">
                    <label for="why_choose_description" class="text-xs">Description</label>
                    <textarea name="why_choose_description" id="why_choose_description" rows="3" placeholder="e.g. We are committed to delivering excellence.">{{ old('why_choose_description') }}</textarea>
                </div>
                <div class="mb-4">
...
Expert Team
On-time Delivery
Scalable Solutions">{{ old('why_choose_points_raw') }}</textarea>
                </div>
            </div>
        </div>
